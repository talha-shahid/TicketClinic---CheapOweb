            ...
            <div className="container relative z-2">
                <div className="grid grid-cols-1 text-center">
                    <div className="">
                        ...
                        <p className="text-slate-400 dark:text-white/60 text-lg max-w-xl mx-auto">TRAFFIC TICKETS | SUSPENDED LICENSE | DUI CHARGES</p>
                        ...
                        <div className="mt-6">
                            ...
                            <p className="text-slate-400 dark:text-white/60 text-sm mt-3">NO POINTS | NO SCHOOL | NO COURT</p>
                        </div>
                    </div>
